...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/contract-templates/general-construction-contract-template&locale=${resolvedParams.locale}&populate[seoData][populate]=*`,
  );
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/contract-templates/general-construction-contract-template",
  });
}
