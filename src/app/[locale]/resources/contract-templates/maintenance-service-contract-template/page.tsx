...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/contract-templates/maintenance-service-contract-template&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/contract-templates/maintenance-service-contract-template",
  });
}
