...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/contract-templates/punch-list-completion-agreement-template&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/contract-templates/punch-list-completion-agreement-template",
  });
}
const PunchListCompletionAgreementPage = () => {
  return <PunchListCompletionAgreement />;
};
