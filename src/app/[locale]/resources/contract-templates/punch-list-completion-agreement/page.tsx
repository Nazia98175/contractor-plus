...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/contract-templates/punch-list-completion-agreement&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/contract-templates/punch-list-completion-agreement",
  });
}
