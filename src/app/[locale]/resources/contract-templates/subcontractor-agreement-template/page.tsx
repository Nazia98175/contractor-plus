...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/contract-templates/subcontractor-agreement-template&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/contract-templates/subcontractor-agreement-template",
  });
}
