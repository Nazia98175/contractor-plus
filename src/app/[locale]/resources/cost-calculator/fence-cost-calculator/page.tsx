...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/cost-calculator/fence-cost-calculator&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/cost-calculator/fence-cost-calculator",
  });
}
const FenceCostCalculatorPage = () => {
  return <FenceCostCalculator />;
};
