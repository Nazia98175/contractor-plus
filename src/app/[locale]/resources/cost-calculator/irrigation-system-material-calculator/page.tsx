...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/cost-calculator/irrigation-system-material-calculator&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/cost-calculator/irrigation-system-material-calculator",
  });
}
const IrrigationSystemCalculatorPage = () => {
  return <IrrigationSystemCalculator />;
};
