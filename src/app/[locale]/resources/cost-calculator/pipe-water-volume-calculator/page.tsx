...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/cost-calculator/pipe-water-volume-calculator&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/cost-calculator/pipe-water-volume-calculator",
  });
}
const PipeWaterVolumeCalculatorPage = () => {
  return <PipeWaterVolumeCalculator />;
};
