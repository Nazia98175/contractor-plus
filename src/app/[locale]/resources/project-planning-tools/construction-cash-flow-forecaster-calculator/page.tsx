...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/project-planning-tools/construction-cash-flow-forecaster-calculator&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/project-planning-tools/construction-cash-flow-forecaster-calculator",
  });
}
