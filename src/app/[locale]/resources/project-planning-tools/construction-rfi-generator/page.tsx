...
export async function generateMetadata({
  ...
  const page = await getSeoDataCommon(
    `resources?filters[slug][$eq]=/resources/project-planning-tools/construction-rfi-generator&
  ...
  return generateSeoMetaData({
    page,
    slug: "/resources/project-planning-tools/construction-rfi-generator",
  });
}
const ConstructionRFIGeneratorPage = () => {
  return <ConstructionRFIGenerator />;
};
