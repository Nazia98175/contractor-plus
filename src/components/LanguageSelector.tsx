...
const LanguageSelector = () => {
  ...
  return (
    <select
      ...
      className="bg-transparent border rounded px-1 xl:px-2 text-superSilver font-medium tracking-[0.1px] leading-[142.857%] cursor-pointer lg:text-xs text-sm border-none outline-none"
    >
