...
const MainLoader = () => {
  console.log("MainLoader component rendered");
  
  return (
    <div className="bg-kuroiBlack main-loader fixed inset-0 z-[9999] flex h-screen w-full items-center justify-center">
