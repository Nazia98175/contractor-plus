...
import { EditToolsIcon, RedClipIcon, SideIcon } from "../common/Icons";
import AdaptiveHeroTitle from "../industry/AdaptiveHeroTitle";
import LottieAnimation from "../homepage/LottieAnimation";
import useGsapFadeIn from "@/hooks/useGsapFadeIn";
import Button from "../common/Button";
import { MultiStepQuoteForm } from "../common/MultiStepQuoteForm";
...
const CommonHero: React.FC<TheHeroProps> = ({
  ...
  return (
    <>
      ...
      <MultiStepQuoteForm open={isModalOpen} onOpenChange={setIsModalOpen} />
    </>
  );
};
