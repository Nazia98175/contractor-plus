      ...
      <div className="max-w-[1050px] w-full mx-auto pt-[46px] sm:pt-20 lg:pt-[139px] xl:pt-[154px]">
        ...
        <div className="px-2 pt-8 md:pt-0">
          <TextAnimation animateOnScroll={false} delay={3}>
            <h2 className="gradient-2 w-fit main-heading !text-start sm:!text-center mx-auto mb-1.5 sm:mb-4 md:mb-[26px]">
              A{" "}
          ...
          <TextAnimation animateOnScroll={false} delay={3}>
            <p className="text-decemberSky text-xs sm:text-sm md:text-base lg:text-lg font-semibold md:font-medium max-w-[826px] mx-auto mb-4 md:mb-[26px] !text-start sm:!text-center">
