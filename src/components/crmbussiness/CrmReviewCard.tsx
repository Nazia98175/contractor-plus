  ...
  return (
    <>
      <article
        ...
        key={review.id}
        className="bg-white w-full hover:-translate-y-1 duration-300 cursor-pointer relative z-20 group"
      >
        <div className="flex gap-3 md:gap-4 items-center">
          ...
          <div className="w-full flex flex-col gap-1.5">
            <div className="flex justify-between w-full flex-wrap sm:flex-nowrap gap-1.5 sm:gap-2">
              <div className="text-left max-w-[182px]">
                <h5 className="text-xl lg:text-2xl font-inter font-medium tracking-[0.1px] text-lightBlack text-nowrap truncate">
                  {review.userName}
                </h5>
        ...
        <p className="text-sm p-2 md:text-base text-left xl:text-lg tracking-[0.1px] font-medium font-jakarta text-winterWay mt-3">
          "{review.review}"
        </p>
      </article>
    </>
