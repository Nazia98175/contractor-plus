...
const FieldServiceCard: React.FC<Props> = ({ service }) => {
  return (
    <article className="field-service-card max-h-[491px] h-full overflow-auto flex lg:flex-row flex-col justify-between text-white p-2.5 lg:p-8 max-w-[1272px] mx-auto rounded-[14px] xl:rouded-[40px] no-scrollbar relative">
