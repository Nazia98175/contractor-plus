  ...
  return (
    <section className="relative z-10 px-2 pt-9 md:pt-11" ref={sectionRef}>
      ...
      <TextAnimation animateOnScroll={true} delay={0.2}>
        <h3 className="font-jakarta text-secondary xs:max-w-[75%] mx-auto max-w-[96%] text-center text-xl font-semibold sm:max-w-[818px] sm:text-2xl md:text-3xl lg:text-[36px]">
          {switchingTool?.title}
        </h3>
      </TextAnimation>
