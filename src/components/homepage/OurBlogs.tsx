    ...
    <section className="py-12 px-4">
      <div className="max-w-[1180px] w-full mx-auto">
        ...
        <div className=" hidden lg:grid grid-cols-2 xl:grid-cols-3 gap-7">
          <article className="py-10 h-[400px] relative">
            <img
              className="absolute top-[91px] right-0 w-full max-w-[266px] z-[-2]"
              src="/images/webp/blog-image-1.webp"
              alt="blog images"
            />
            ...
            <div className="relative py-6 px-4 w-[346px] mt-2">
              <img
                ...
                alt=""
              />
              <h3 className="text-base md:text-lg text-winterWay font-extrabold pb-2 font-jakarta">
                Contractor+ Blog
              </h3>
          ...
          <article className="py-10 h-[400px] relative">
            <img
              className="absolute top-[91px] right-0 w-full max-w-[226px] z-[-2]"
              src="/images/webp/blog-image-2.webp"
              alt="blog images"
            />
            <div className="py-6 relative flex flex-col justify-between  w-[207px] h-[207px]">
              <img
          ...
          <article className="py-10 h-[400px] relative">
            ...
            <img
              className="absolute top-[91px] right-0 w-full max-w-[200px] z-[-2]"
              src="/images/webp/blog-image-3.webp"
              alt="blog images"
            />
            <div className="py-6 relative flex flex-col justify-between w-[207px] h-[207px]">
              <img
              ...
              <div className="px-4">
                <p className="text-wallStreet text-[10px] font-bold pb-2 font-jakarta">
                  Free resources by
                </p>
                <span>
                  <svg
