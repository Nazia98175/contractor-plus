...
const TrustBar = () => {
  return (
    <section className="flex flex-wrap gap-9 justify-center lg:flex-nowrap items-center py-6">
      {platforms.map((platform, index) => (
        <div
          key={index}
          className="flex flex-col-reverse w-[45%] sm:w-fit gap-3.5 sm:flex-col items-center"
        >
          <img
            src={platform.logo}
