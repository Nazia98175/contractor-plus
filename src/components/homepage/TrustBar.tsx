  ...
  return (
    <section className="flex flex-wrap gap-9 justify-center lg:flex-nowrap items-center py-6 relative">
      <img
        ...
        alt="Stars"
      />
      <div className="bg-black-red-linear blur-2xl  right-[-20%] lg:hidden -rotate-90 -top-[80%] rounded-full absolute md:w-[300px] md:h-[400px] max-w-[500px] min-w-[300px] w-full z-0 min-h-[400px]"></div>
