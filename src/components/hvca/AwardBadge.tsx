...
export default function AwardBadges() {
  ...
  return (
    <section
      ref={ref}
      className="main-container relative z-10 bg-[url('/images/webp/red-bg.png')] bg-cover bg-center py-12"
    >
      ...
      <div className="mt-10 flex flex-col items-center text-center">
        ...
        <p className="text-winterWay mt-2 text-sm">No Credit Card Required</p>
      </div>
