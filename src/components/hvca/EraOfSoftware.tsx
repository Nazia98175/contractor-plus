...
const EraOfSoftware = () => {
  return (
    <section className="no-scrollbar relative overflow-x-hidden px-2">
      <div className="bg-white-linear absolute -bottom-[2%] left-0 z-10 hidden h-[180px] w-full md:block lg:h-[237px]"></div>
      ...
      <div className="mx-auto mt-[117px] w-full max-w-[700px] overflow-hidden xl:rounded-[45px]">
