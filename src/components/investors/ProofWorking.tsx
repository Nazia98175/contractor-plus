          ...
          <div className="relative w-full">
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="flex items-center justify-center">
                <img
                  ref={logoDesktopRef}
                  className="relative z-10 w-full max-w-[180px] xl:max-w-[231px]"
            ...
            <div className="mt-8 block space-y-8 lg:hidden">
              {/* Mobile stats layout here - keeping your original mobile layout */}
