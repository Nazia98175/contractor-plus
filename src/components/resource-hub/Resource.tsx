...
const Resource = () => {
  return (
    <div className="flex flex-col gap-12 pt-32 pb-10 text-[#09090b]">
      {/* Hero Section */}
      <section className="main-container px-4 md:px-6">
        <div className="space-y-4 text-center">
          ...
          <p className="animate-slide-in mx-auto max-w-[800px] text-lg text-[#71717a] md:text-xl">
      ...
      <section className="main-container">
        <div className="flex flex-col gap-8 bg-[#f4f4f5] px-4 py-10 md:px-6">
          <div className="text-center">
            <h2 className="mb-3 text-3xl font-bold tracking-tight">
              Free Tools & Templates
            </h2>
            <p className="mx-auto max-w-[800px] text-lg text-[#71717a]">
          ...
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            <ResourceCard
              ...
              icon={<FileText className="h-10 w-10 text-[#dc2626]" />}
            ...
            <ResourceCard
              ...
              icon={<Calculator className="h-10 w-10 text-[#dc2626]" />}
              link="/calculators"
            ...
            <ResourceCard
              ...
              icon={<BarChart3 className="h-10 w-10 text-[#dc2626]" />}
              link="/compare"
            ...
            <ResourceCard
              ...
              icon={<Wrench className="h-10 w-10 text-[#dc2626]" />}
      ...
      <section className="main-container px-4 md:px-6">
        <div className="flex flex-col gap-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <button className="flex items-center gap-1 text-[#dc2626] hover:underline">
              Go to Contractor+ HQ
      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/podcasts"
            className="text-[#dc2626] flex items-center gap-1 hover:underline"
          >
