                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-xs">
                            <p className="text-sm">
                              The size of all the carpeted areas combined. If
                              you have multiple rooms, add up their areas.
                              (Length × width for each room and sum it.) If you
                              know it in square meters, convert to sq ft by
                              multiplying by 10.764.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-xs">
                            <p className="text-sm">
                              ...
                              level. For example, $0.25/ft² is $25 per 100 sq
                              ft. Enter the amount in dollars.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-xs">
                            <p className="text-sm">
                              ...
                              cleaners have a minimum (e.g., $100) to cover
                              travel and setup. If the calculated cost by area
                              is below this, the minimum will be used as the
                              base price. If you don't enforce a minimum, leave
                              this as 0.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-xs">
                            <p className="text-sm">
                              ...
                              deep stain treatment, $15 for moving furniture,
                              etc. Sum up all those extras for the job and enter
                              the total here.
                            </p>
                          </TooltipContent>
                        </Tooltip>
