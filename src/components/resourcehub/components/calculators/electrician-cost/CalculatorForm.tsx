...
export function CalculatorForm({ onCalculate }: CalculatorFormProps) {
  ...
  return (
    <Card className="border-stiletto bg-shutter h-full border shadow-sm">
      ...
      <CardContent className="h-auto pt-6">
        <Form {...form}>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-80">
                            ...
                            makes $20/hour, enter 20. If you're calculating for
                            yourself, it might be what income per hour you
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-80">
                            ...
                            wage, enter 20. If you're not sure, 15-30% is common
                            in trades.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-80">
                            ...
                            overhead (office rent, truck, gas, insurance, phone,
                            etc.) and divide by billable hours in a month.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <div className="flex justify-between">
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="w-80">
                            The percentage you want to earn as profit on top of
                            all costs. This will effectively determine your
