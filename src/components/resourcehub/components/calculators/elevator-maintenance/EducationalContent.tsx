...
export function EducationalContent() {
  return (
    <div className="mt-10">
      ...
      <div className="mb-6 rounded-xl border border-red-100 bg-red-50 p-6 dark:border-red-800/20 dark:bg-red-900/10">
        <div className="mb-4 flex items-center gap-3">
          <div className="rounded-full bg-red-100 p-2 dark:bg-red-900/30">
            <ArrowUp className="h-5 w-5 text-red-600 dark:text-red-500" />
          </div>
