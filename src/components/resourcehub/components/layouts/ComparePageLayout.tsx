  ...
  return (
    <section className="mx-auto max-w-6xl">
      <div className="grid grid-cols-1 gap-8 px-4 py-8">
        ...
        <div className="text-left">
          <div className="flex items-start gap-3">
            <div className="mt-1 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-red-100 shadow-sm lg:h-12 lg:w-12">
            ...
            <div>
              ...
              <p className="text-aliceBlue mt-2 max-w-3xl text-sm xl:mt-3 xl:text-base">
                Find and compare construction materials, building supplies and
                home improvement products across major suppliers like Lowe's,
                Home Depot, Build.com, and more to get the best prices for your
                projects.
              </p>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="border-stiletto rounded-lg border p-4 shadow-sm sm:p-6">
            ...
            <div className="text-aliceBlue mb-8 space-y-4">
              <p>
                The Material Price Comparison Tool helps contractors, builders,
                and DIY enthusiasts find the best prices on construction
                materials and home improvement products across major suppliers.
                By comparing prices in real-time, you can save money on your
                projects and ensure you're getting the most value for your
                budget.
              </p>
              ...
              <ol className="list-decimal space-y-3 pl-5">
                ...
                <li>
                  Adjust quantities as needed to match your project requirements
                </li>
                <li>
                  Use the export options to save your materials list for future
                  reference
                </li>
              </ol>
              ...
              <p className="mt-4">
                ...
                materials for any project. Our tool makes it easy to compare not
                just prices, but also availability and specifications across
                different suppliers, ensuring you make informed purchasing
                decisions.
              </p>
            ...
            <div className="bg-shutter rounded-lg p-4 md:p-6">
              ...
              <p className="mb-4">
                Contractor+ offers a complete solution for professionals looking
                to streamline their material ordering process. With our advanced
                Estimates & Quotes platform, you can:
              </p>
      ...
      <div className="mx-4 mb-6 rounded-md border border-gray-800 bg-gray-900 px-4 py-8 text-xs text-gray-400">
        ...
        <p className="mb-2">
          The material comparison pricing search tool provided by Contractor+ is
          a free informational resource intended to assist visitors in locating
          and comparing building materials across various suppliers. Contractor+
          is a registered affiliate partner with suppliers including, but not
          limited to, Lowe's, Build with Ferguson, Ace Hardware, Lumber
          Liquidators, and Amazon. As an affiliate, Contractor+ may earn
          commissions from qualifying purchases made through links provided
          within this comparison index.
        </p>
        <p className="mb-2">
          ...
          respective suppliers and are used herein solely for identification and
          comparison purposes. Contractor+ makes no claim of ownership or
          endorsement by the suppliers. Pricing, availability, and product
          details are provided "as-is" and are subject to change without notice
          by the respective suppliers. Contractor+ does not guarantee the
          accuracy, completeness, or current availability of any product
          information or pricing displayed herein and shall not be held liable
          for any inaccuracies, discrepancies, or losses arising from the use of
          this tool.
        </p>
        <p>
