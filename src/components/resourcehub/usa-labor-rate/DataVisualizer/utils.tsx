...
// import { renderIndustryTooltip, renderStateTooltip } from './utils/chartTooltips';
// import { getSourceColors, getSourceKey } from './utils/common';

// // Function to render the tooltip for different chart types
// export const renderTooltip = (props: any, chartType: string, filters: FilterState, industries: Industry[], states: State[]) => {
//   if (chartType === 'trend') {
