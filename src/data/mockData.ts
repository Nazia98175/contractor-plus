...
export const industries: Industry[] = [
  {
    ...
    description:
      "Oversee entire construction projects, including residential, commercial, and industrial.",
  },
  {
    id: 2,
    name: "Roofing Contractors",
    description:
      "Install, repair, and maintain roofs for homes, businesses, and industrial buildings.",
  },
  {
    id: 3,
    name: "Electrical Contractors",
    description:
      "Handle electrical system installations, wiring, and maintenance for residential, commercial, and industrial clients.",
  },
  {
    id: 4,
    name: "HVAC Contractors",
    description:
      "Specialize in heating, ventilation, and air conditioning system installation, repair, and maintenance.",
  },
  {
    id: 5,
    name: "Plumbing Contractors",
    description:
      "Install and repair water, sewer, and gas lines, along with plumbing fixtures.",
  },
  {
    id: 6,
    name: "Mechanical Contractors",
    description:
      "Work on large-scale mechanical systems, including HVAC, refrigeration, and piping.",
  },
  {
    id: 7,
    name: "Concrete Contractors",
    description:
      "Specialize in concrete foundations, driveways, sidewalks, parking lots, and structural concrete work.",
  },
  {
    id: 8,
    name: "Painting Contractors",
    description:
      "Provide interior and exterior painting services for residential, commercial, and industrial projects.",
  },
  {
    id: 9,
    name: "Drywall Contractors",
    description:
      "Install drywall in residential and commercial buildings, including finishing and texturing.",
  },
  {
    id: 10,
    name: "Flooring Contractors",
    description:
      "Handle the installation of hardwood, tile, laminate, carpet, and other flooring materials.",
  },
  {
    id: 11,
    name: "Siding Contractors",
    description:
      "Install and repair siding for homes and commercial buildings, including vinyl, fiber cement, and wood.",
  },
  {
    id: 12,
    name: "Doors & Windows Contractors",
    description:
      "Install and replace doors and windows for energy efficiency, aesthetics, and security.",
  },
  {
    id: 13,
    name: "Masonry Contractors",
    description:
      "Work with brick, stone, and concrete blocks for walls, chimneys, facades, and hardscapes.",
  },
  {
    id: 14,
    name: "Excavation & Site Preparation",
    description:
      "Handle land clearing, grading, trenching, and site prep for construction projects.",
  },
  {
    id: 15,
    name: "Steel & Structural Contractors",
    description:
      "Specialize in steel fabrication, erection, and structural framework for buildings and infrastructure.",
  },
  {
    id: 16,
    name: "Carpentry Contractors",
    description:
      "Focus on wood framing, trim work, cabinetry, and finish carpentry in construction.",
  },
  {
    id: 17,
    name: "Insulation Contractors",
    description:
      "Install insulation materials for thermal and soundproofing applications.",
  },
  {
    id: 18,
    name: "Landscaping & Hardscaping",
    description:
      "Work on outdoor spaces, including planting, patios, retaining walls, and drainage solutions.",
  },
  {
    id: 19,
    name: "Glass & Glazing Contractors",
    description:
      "Install glass windows, storefronts, curtain walls, and decorative glass features.",
  },
  {
    id: 20,
    name: "Demolition Contractors",
    description:
      "Specialize in tearing down buildings, structures, and interior spaces safely and efficiently.",
  },
];
...
export const generateLaborRates = (): LaborRate[] => {
  ...
  const uoms: Array<"Hour" | "Square Foot" | "Linear Foot" | "Unit"> = [
    "Hour",
    "Square Foot",
    "Linear Foot",
    "Unit",
...
export const getZipCodeLaborRates = (
  zipCode: string,
  radius: number = 100,
): ZipCodeLaborRate[] => {
