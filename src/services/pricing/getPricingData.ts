...
export const getPricingData = async (
  ...
  const [
    ...
    getPricingPage(locale, "&populate[plans][populate][plans][populate]=*"),

    getPricingPage(
      locale,
      "&populate[pricingPlanComparison][populate][plans]=*&populate[pricingPlanComparison][populate][comparisonTable][populate][features][populate]=avilability",
    ),
  ...
  return {
    ...
    pricingComparison:
      pricingPlanComparisonRes?.data?.pricingPlanComparison || null,
