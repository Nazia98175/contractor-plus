...
const formatMockResponse = (
  ...
  return materials.map((material: Material) => {
    ...
    const updatedVariations = material.variations.map(
      (variation: Variation) => {
...
const drywallData = [
  {
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/e9589d6f-6175-4625-8f70-01be5feb212a/svn/gold-bond-drywall-sheets-50043-64_1000.jpg",
  },
  {
    id: "2",
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/c1f21c9d-81aa-4864-aaac-0c9e1ce96be5/svn/gold-bond-drywall-sheets-50046-e1.jpg",
  },
  {
    id: "3",
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/d499c2da-f4fd-4322-a8be-96363f1ed955/svn/gold-bond-drywall-sheets-05014-64_1000.jpg",
  },
  {
    id: "4",
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/7e075f92-3440-4cfb-a6e1-48c3fbe7d988/svn/sheetrock-drywall-sheets-14113411708-64_1000.jpg",
  },
  {
    id: "5",
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/92cebd43-c634-4786-b905-fa67b7e10d3c/svn/gold-bond-drywall-sheets-gb50004800-64_1000.jpg",
  },
  {
    id: "6",
    ...
    category: "drywall",
    image:
      "https://images.thdstatic.com/productImages/13344ebb-aa11-4cc7-9d2e-d4a87bf91553/svn/certainteed-drywall-sheets-60048-11000-e1.jpg",
  },
];
...
const materialData = [
  ...
  },
  {
    ...
    category: "plumbing",
    image:
      "https://images.thdstatic.com/productImages/b22f5de7-378e-4c92-a7e9-7a0eaa4ecf9c/svn/charlotte-pipe-pvc-pipe-pvc-04010-0600-64_1000.jpg",
  },
  {
    id: "5",
    ...
    category: "electrical",
    image:
      "https://images.thdstatic.com/productImages/2037cb85-d935-4ade-a572-65f573c8e0a9/svn/southwire-electrical-wire-28828221-64_1000.jpg",
  },
  {
    id: "6",
    ...
    category: "gc",
    image:
      "https://images.thdstatic.com/productImages/ff21db19-d1ab-4f4c-b2f1-3c0c89ed70f6/svn/dimensional-lumber-161640-64_1000.jpg",
  },
];
...
export const searchMaterials = async (query: string, options: any) => {
  return new Promise((resolve) => {
    ...
    setTimeout(() => {
      ...
      const dataSource = query.toLowerCase().includes("drywall")
        ? drywallData
        : materialData;
...
export const exportMaterialList = async (
  items: any[],
